export default function SimpleCard({ imageURL, title, price, status }) {
  return (
    <div class='flex'>
      <div class='flex-none w-48 relative'>
        <img
          src={imageURL || 'https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80'}
          alt=''
      ...
      <form class='flex-auto p-6'>
        <div class='flex flex-wrap'>
          ...
          <div class='text-xl font-semibold text-gray-500'>${price}</div>
