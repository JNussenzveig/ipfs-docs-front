    ...
    <div className='flex flex-col items-center w-40 h-full overflow-hidden text-gray-300 bg-indigo-900'>
      ...
      <div className='w-full px-2'>
        ...
        <div className='flex flex-col items-center w-full mt-2 border-t border-indigo-700'>
          ...
          <a
            className='relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-800 hover:text-gray-300'
            href='#'
          >
            <svg
              className='w-6 h-6 stroke-current'
            ...
            <span className='ml-2 text-sm font-medium'>Mensagens</span>
